export const photoCards = [
  {
    ...
    content: () => {
      return (
        <p>
          After a long learning journey, we decide to join Digital Innovation Sandbox Season 3 with idea from Microsoft AI for Accessibility Hackathon 2023.
          We had learn a lot in market research, business model, and how to pitch our idea to the investor.
        </p>
      );
    },
  },
  {
    description: "Bootcamp + Hackathon",
    title: "ExxonMobil IT Bootcathon 2024",
    src: "/exxon_bootcathon.jpg",
    ctaText: "Visit",
    ctaLink: "https://ui.aceternity.com/templates",
    content: () => {
      return (
